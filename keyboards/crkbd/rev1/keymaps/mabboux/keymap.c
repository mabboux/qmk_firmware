...
enum custom_keycodes {
 ...
 [_LAYER0] = LAYOUT(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_RSFT, KC_RCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_DEL, KC_LGUI, MO(1), KC_SPC, KC_ENT, MO(2), KC_RALT),
...
[_LAYER4] = LAYOUT(KC_2, KC_PSLS, KC_PAST, KC_PPLS, KC_PMNS, KC_MINS, KC_ASTR, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_BSPC, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_LPRN, KC_P4, KC_P5, KC_P6, KC_COMM, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PAST, KC_P1, KC_P2, KC_P3, KC_DOT, KC_NO, KC_NO, KC_NO, KC_SPC, KC_ENT, TG(4), KC_P0) 
